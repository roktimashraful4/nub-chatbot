...
LIST_URL = f"{BASE_URL}/management/ax3epgi6/executives"
...
with sync_playwright() as p:
    ...
    faculty_links = []
    main_div = soup.find_all("div", {"class": "profile"})
    if main_div:
        for profile in main_div:
            for article in profile.find_all("div", {"class": "profile-item"}):
                a = article.find("a")
                # print(a)
